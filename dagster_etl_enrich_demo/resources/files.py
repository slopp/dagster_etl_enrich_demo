...
import boto3
import pandas as pd
from dagster import Field, IOManager, io_manager, resource

# --- Excel
class ExcelIOManager(IOManager):
    """Loads excel file as source asset using configured file system"""
...
class CSVIOManager(IOManager):
    """Loads a csv file as source asset using configured file system"""
...
class s3FileSystem:
    """resource to interact with s3 objects"""
    ...
    def get_mtime(self, filename):
        """Get last updated time for s3 object"""
