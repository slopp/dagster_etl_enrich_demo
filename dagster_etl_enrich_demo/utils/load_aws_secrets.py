...
def load_aws_secret(
    secret_name, region_name: Optional[str] = None, profile_name: Optional[str] = None
):
    """
    ...
    """
    secrets = construct_secretsmanager_client(
        max_attempts=1, region_name=region_name, profile_name=profile_name
    )
